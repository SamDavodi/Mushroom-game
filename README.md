...
function init(){
  ...
  const configs=[
    [{x:60,y:h-160,w:130,h:15},

{x:240,y:h-240,w:130,h:15},{x:430,y:h-185,w:130,h:15},{x:620,y:h-280,w:130,h:15},{x:w-220,y:h-320,w:160,h:15}],
...
function setHP()(){
  let s='';
  for(let i=0;i<3;i++) s+=i<lives?'<span style="color:#ff4466">♥❤️❤️</span>':'<span style="opacity:.2">❤️❤️♥</span>';
